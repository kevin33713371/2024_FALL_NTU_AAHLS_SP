; ModuleID = '/home/ubuntu/Desktop/2024_Fall_NTU_AAHLS_SP/LabB_Systolic_Array/Vitis_HLS/SA_tiling/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  %a_copy = bitcast i8* %malloccall to [1024 x i32]*
  %malloccall1 = tail call i8* @malloc(i64 4096)
  %b_copy = bitcast i8* %malloccall1 to [1024 x i32]*
  %malloccall2 = tail call i8* @malloc(i64 4096)
  %c_copy = bitcast i8* %malloccall2 to [1024 x i32]*
  %0 = bitcast i32* %a to [1024 x i32]*
  %1 = bitcast i32* %b to [1024 x i32]*
  %2 = bitcast i32* %c to [1024 x i32]*
  call fastcc void @copy_in([1024 x i32]* nonnull %0, [1024 x i32]* %a_copy, [1024 x i32]* nonnull %1, [1024 x i32]* %b_copy, [1024 x i32]* nonnull %2, [1024 x i32]* %c_copy)
  %3 = getelementptr inbounds [1024 x i32], [1024 x i32]* %a_copy, i32 0, i32 0
  %4 = getelementptr inbounds [1024 x i32], [1024 x i32]* %b_copy, i32 0, i32 0
  %5 = getelementptr inbounds [1024 x i32], [1024 x i32]* %c_copy, i32 0, i32 0
  call void @apatb_mmult_hw(i32* %3, i32* %4, i32* %5, i32 %a_row, i32 %a_col, i32 %b_col)
  call void @copy_back([1024 x i32]* %0, [1024 x i32]* %a_copy, [1024 x i32]* %1, [1024 x i32]* %b_copy, [1024 x i32]* %2, [1024 x i32]* %c_copy)
...
entry:
  %6 = bitcast i32* %0 to [1024 x i32]*
  %7 = bitcast i32* %1 to [1024 x i32]*
  %8 = bitcast i32* %2 to [1024 x i32]*
  call void @copy_out([1024 x i32]* null, [1024 x i32]* %6, [1024 x i32]* null, [1024 x i32]* %7, [1024 x i32]* null, [1024 x i32]* %8)
  ...
  call void @copy_in([1024 x i32]* null, [1024 x i32]* %6, [1024 x i32]* null, [1024 x i32]* %7, [1024 x i32]* null, [1024 x i32]* %8)
  ret void
}
